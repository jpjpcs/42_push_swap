...
/*   Updated: 2023/09/21 02:34:06 by jode-jes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	push_func(t_stack_node **src, t_stack_node **dst, char *cmd);
void	rotate(t_stack_node **a, t_stack_node **b, char *cmd);
void	reverse_rotate(t_stack_node **a, t_stack_node **b, char *cmd);
void	move(t_stack_node **first, t_stack_node **second, char *cmd);
